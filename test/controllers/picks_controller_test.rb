...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference("Pick.count") do
      post picks_url, params: { pick: { group_id: @pick.group_id, school_id: @pick.school_id, user_id: @pick.user_id } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { group_id: @pick.group_id, school_id: @pick.school_id, user_id: @pick.user_id } }
